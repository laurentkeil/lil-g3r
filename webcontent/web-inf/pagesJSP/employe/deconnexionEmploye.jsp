<!-- Page permettant à l'employé de se déconnecter -->
<%@ page pageEncoding="UTF-8" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>HLB-Express | Déconnexion</title>
...
<div class="main">
  ...
  <div class="content">
	<div class="content_resize">
      	<div class="mainbar">
        	<div class="article">
        		<h2><span>Déconnexion</span></h2>
        		</br>
 				<form method="post" action="<c:url value="/DeconnexionEmploye" />">
	 				Êtes-vous sûr de vouloir vous déconnecter ? </br></br>
	 				<input type="radio" id="deco" name="deco" value="Non" checked /> Non
	                <input type="radio" id="deco" name="deco" value="Oui" /> Oui
	 				</br>
	 				</br>
