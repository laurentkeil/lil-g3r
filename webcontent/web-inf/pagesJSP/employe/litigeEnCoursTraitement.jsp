<!-- Page permettant de signaler d'un problème signalé par un coursier est en cours de traitement -->
<%@ page pageEncoding="UTF-8" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>HLB-Express | En cours de traitement</title>
...
<div class="main">
  ...
  <div class="content">
	<div class="content_resize">
      	<div class="mainbar">
        	<div class="article">
        		Ce problème est actuellement en cours de traitement.
        	</div>
      </div>
      <div class="clr"></div>
    </div>
