<!-- Page contenant les informations sur les centres de HLB-Express -->
<%@ page pageEncoding="UTF-8" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>HLB-Express | Conditions</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
        <c:choose>
    		<c:when test="${centres == 'employe'}">
    			<c:import url="/inc/employe/menu.jsp" />
    		</c:when>
    		<c:when test="${centres == 'client'}">
	...
	<div class="content_resize">
      	<div class="mainbar">
        	<div class="article">
          		...
          		<div class="clr"></div>
          		<p>
	          		 <c:import url="/inc/texte/nosCentres.jsp" />
          		</p>
        	</div>
      </div>
      <div class="clr"></div>
