...
<head>
<title>HLB-Express | Accueil Client</title>
...
<div class="main">
  ...
  <div class="content">
	<div class="content_resize">
      	<div class="mainbar">
        	<div class="article">
	          	<h2><span>Generation de QR-code</span></h2>
	          	<form action="GenerateQRCode" method="get">
			        <p>Entrez un texte pour générer le QR-code</p>
      ...
      <c:import url="/inc/client/menu_cote.jsp" />
      <div class="clr"></div>
    </div>
  </div></div>
  <div class="clr"></div>
