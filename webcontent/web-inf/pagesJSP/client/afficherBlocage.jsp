<!-- Page permettant de signaler au client qu'il ne lui est plus possible de commander tant qu'il a encore des
surfacturations -->
...
<head>
<title>HLB-Express | Blocage compte client</title>
...
<div class="main">
  ...
  <div class="content">
	<div class="content_resize">
      	<div class="mainbar">
        	<div class="article">
          		<h2>Votre compte a été bloqué pour la raison suivante :</h2>
          		<h3><span class="erreur"> ${cause} </span>
          		</br></br> Vous ne pouvez désormais plus passer de commandes tant que ce problème ne sera pas réglé.</h3>
        	</div>
      </div>
      <div class="clr"></div>
    </div>
